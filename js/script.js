...
function generate(){
	...
	document.getElementById('result').innerHTML = "<h1>Nombre:</h1><div class='alert alert-success'><h2>"+firstname[rand_first]+" "+lastname[rand_last]+" "+rand_num+"</h2></div>";
	fetch("http://localhost:9000/api/users/name/"+firstname[rand_first]+" "+lastname[rand_last]+" "+rand_num).then (response=>response.json()).then (resultado => {
